...
if ( function_exists( 'add_image_size' ) ) { 
	add_image_size( 'tech', 250, 150, true );
}
...
// Footer Menu.
register_nav_menu( 'footer-menu', __( 'Footer Menu', 'cyberchimps' ) );

//Header Drag and Drop options and Default
